...
def print_all_records():
    ...
    conn = pyodbc.connect(r'Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=C:\Users\ender\OneDrive\Documents\WITT\4DCA\Assignments\Assessment_4\DCA_Assessment4\company.accdb')
    cursor = conn.cursor()
